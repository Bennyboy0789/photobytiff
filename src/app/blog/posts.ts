...
export const blogPosts: BlogPost[] = [
  {
    slug: 'maternity-photography-spring-lake-nc',
    title: 'Maternity Photography in Spring Lake, NC: What to Expect & When to Book',
    date: 'June 08, 2026',
    category: 'Maternity',
    image: '/images/blog/maternity-photography-spring-lake-nc-featured.jpg',
    excerpt:
      "Planning your maternity photos is one of those things that can feel overwhelming before you even start. When should you book? What should you wear? Will you feel comfortable in front of the camera? These are all normal questions — and I promise, you're not alone in asking them. As a lifestyle maternity photographer in Spring Lake, NC, I've guided dozens of expecting moms through this process. Here's everything I want you to know before your session. WHEN TO BOOK YOUR MATERNITY SESSION The sweet spot for maternity photos is between 28 and 34 weeks. By this point, your bump is beautifully round and prominent, but you're not yet at the stage where standing for long periods gets uncomfortable. If you're expecting twins, aim closer to 24-28 weeks since twin pregnancies tend to show earlier and deliver sooner. I recommend reaching out to book by your second trimester — around 16-20 weeks. This gives us plenty of time to plan your session, choose a location, and coordinate outfits. Spring and fall dates fill up especially fast in the Fayetteville and Spring Lake area, so don't wait until the last minute. WHAT TO WEAR FOR YOUR MATERNITY PHOTOS The most important rule: wear something you feel beautiful in. If you're tugging at your dress or adjusting straps the whole time, it will show in the photos. Flowy maxi dresses create gorgeous movement and highlight your bump. Solid colors or subtle patterns avoid busy prints that distract. Soft, neutral tones like creams, blush, sage, dusty blue, and warm earth tones photograph timelessly. For your partner: coordinate, don't match. Bare feet or simple sandals work well since we're often in fields or on trails. You're welcome to bring one outfit change. Many moms choose one flowing dress for golden hour shots and something more fitted for a second look that really shows off the bump. WHERE WE'LL SHOOT Spring Lake and the surrounding areas offer some truly beautiful backdrops for maternity sessions. I have several go-to locations with open fields, tall grass, golden light, tree-lined paths with dappled shade, lake views especially stunning at sunset, and wildflower patches in spring and early summer. I'll suggest locations based on the season and the look you're going for. And if you have a spot that's meaningful to you and your partner, I love incorporating personal locations. WHAT TO EXPECT DURING YOUR SESSION My approach to maternity photography is relaxed and natural. I guide you into gentle, natural interactions with your partner and your bump — walking together, a hand on your belly, forehead touches, real laughter. Sessions typically last 60-90 minutes during golden hour. If you have older children, they're absolutely welcome to join. MILITARY FAMILIES I photograph many military families from Fort Liberty, and I know deployment schedules don't always cooperate. Reach out early and I'll do everything I can to accommodate your timeline. AFTER YOUR SESSION Within two weeks you'll receive your full edited gallery — typically 50-70 images with full printing rights. Many mamas book their newborn session after seeing their maternity photos. READY TO BOOK? If you're pregnant and looking for a maternity photographer in Spring Lake, Fayetteville, Fort Liberty, or the surrounding NC area — I'd love to hear from you. You're growing a human. That deserves to be documented beautifully.",
  },
  {
    slug: 'how-to-choose-coordinating-outfits-family-session',
  ...
  {
    slug: 'what-is-a-cake-smash-session',
  ...
  {
    slug: 'what-is-a-milestone-session',
  ...
  {
    slug: 'what-is-a-baby-led-newborn-session',
  ...
  {
    slug: 'what-is-a-lifestyle-photographer',
  ...
  {
    slug: 'childrens-milestone-photography',
  ...
  {
    slug: 'photographer-behind-the-scenes',
  ...
  {
    slug: 'is-hiring-a-professional-photographer-worth-it',
  ...
  {
    slug: 'how-to-prepare-for-a-photoshoot',
  ...
  {
    slug: 'sunflower-field-mini-session',
  ...
  {
    slug: 'what-to-wear-to-a-photoshoot',
