...
export const blogPosts: BlogPost[] = [
  {
    slug: 'test-automated-pipeline',
    title: 'Test: Automated Blog Pipeline Works',
    date: "June 01, 2026",
    category: 'Tips',
    image: '/images/real/family-outdoor-session-lifestyle-banner.jpg',
    excerpt: 'This is a test post generated by the Hermes Agent blog pipeline. It confirms the automated publishing workflow for Photography By Tiffany is working correctly. The post will be removed after verification.',
  },
  {
